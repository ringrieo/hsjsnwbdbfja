...
// ... (이어서 showQuestion, checkAnswer, showScore, startQuiz 등 로직 추가)
...
function checkAnswer(selected) {
  ...
  if (q.type === "mc") {
    ...
    if (selected === q.answer) {
      optionButtons[selected ? 0 : 1].classList.add("correct");
      score++;
    } else if (selected !== null) {
      optionButtons[selected ? 0 : 1].classList.add("incorrect");
      optionButtons[q.answer ? 0 : 1].classList.add("correct");
    }
  }
